...
@Component({
  selector: 'app-customer-payments-reports',
  providers: [ReportsService],

  templateUrl: './customer-payments-reports.component.html',
  styleUrls: ['./customer-payments-reports.component.css']
})
export class CustomerPaymentsReportsComponent implements OnInit {
  ...
  ExportoCsv() {
    ...
    new Angular5Csv(this.DataToCsv, 'تقرير بمدفوعات العملاء', options);
